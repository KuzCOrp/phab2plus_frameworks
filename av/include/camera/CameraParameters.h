...
public:
    ...
    //yeqihua add for focus distance
    static const char KEY_FOCUS_DISTANCE[];
    static const char FOCUS_DISTANCE_AUTO[];
    static const char FOCUS_DISTANCE_10[];
    static const char FOCUS_DISTANCE_11[];
    static const char FOCUS_DISTANCE_13[];
    static const char FOCUS_DISTANCE_15[];
    static const char FOCUS_DISTANCE_20[];
    static const char FOCUS_DISTANCE_25[];
    static const char FOCUS_DISTANCE_30[];
    static const char FOCUS_DISTANCE_40[];
    static const char FOCUS_DISTANCE_60[];
    static const char FOCUS_DISTANCE_80[];
    static const char FOCUS_DISTANCE_100[];
    static const char FOCUS_DISTANCE_150[];
    static const char FOCUS_DISTANCE_200[];
    static const char FOCUS_DISTANCE_300[];
    static const char FOCUS_DISTANCE_400[];
    static const char FOCUS_DISTANCE_500[];
    static const char FOCUS_DISTANCE_INF[];

    //yeqihua add for exposure time
    static const char KEY_EXPOSURE_TIME[];
    static const char EXPOSURE_TIME_AUTO[];
    static const char EXPOSURE_TIME_1_3200[];
    static const char EXPOSURE_TIME_1_1600[];
    static const char EXPOSURE_TIME_1_800[];
    static const char EXPOSURE_TIME_1_400[];
    static const char EXPOSURE_TIME_1_200[];
    static const char EXPOSURE_TIME_1_100[];
    static const char EXPOSURE_TIME_1_50[];
    static const char EXPOSURE_TIME_1_25[];
    static const char EXPOSURE_TIME_1_10[];
    static const char EXPOSURE_TIME_1_5[];
    static const char EXPOSURE_TIME_1_2[];
    static const char EXPOSURE_TIME_1[];
    static const char EXPOSURE_TIME_2[];
    static const char EXPOSURE_TIME_3[];
    static const char EXPOSURE_TIME_4[];
    static const char EXPOSURE_TIME_6[];
    static const char EXPOSURE_TIME_8[];
    static const char EXPOSURE_TIME_10[];
    static const char EXPOSURE_TIME_12[];
    static const char EXPOSURE_TIME_14[];
    static const char EXPOSURE_TIME_16[];
    static const char EXPOSURE_TIME_20[];
    static const char EXPOSURE_TIME_24[];
    static const char EXPOSURE_TIME_28[];
    static const char EXPOSURE_TIME_32[];

    //yeqihua add for digital zoom
    static const char KEY_DIGITAL_ZOOM[];
    static const char DIGITAL_ZOOM_10[];
    static const char DIGITAL_ZOOM_12[];
    static const char DIGITAL_ZOOM_14[];
    static const char DIGITAL_ZOOM_16[];
    static const char DIGITAL_ZOOM_18[];
    static const char DIGITAL_ZOOM_20[];
    static const char DIGITAL_ZOOM_23[];
    static const char DIGITAL_ZOOM_26[];
    static const char DIGITAL_ZOOM_30[];
    static const char DIGITAL_ZOOM_33[];
    static const char DIGITAL_ZOOM_37[];
    static const char DIGITAL_ZOOM_40[];

    //yeqihua add for HDR Mode
    static const char KEY_HDR_MODE[];
    static const char HDR_MODE_OFF[];
    static const char HDR_MODE_ON[];

    //yeqihua add for MFC Mode
    static const char KEY_MFC_MODE[];
    static const char MFC_MODE_OFF[];
    static const char MFC_MODE_ON[];

    //yeqihua add for hdr-ev
    static const char KEY_HDR_EV[];
    static const char HDR_EV_COMP_00[];
    static const char HDR_EV_COMP_03[];
    static const char HDR_EV_COMP_05[];
    static const char HDR_EV_COMP_07[];
    static const char HDR_EV_COMP_10[];
    static const char HDR_EV_COMP_13[];
    static const char HDR_EV_COMP_15[];
    static const char HDR_EV_COMP_17[];
    static const char HDR_EV_COMP_20[];
    static const char HDR_EV_COMP_30[];
    static const char HDR_EV_COMP_n03[];
    static const char HDR_EV_COMP_n05[];
    static const char HDR_EV_COMP_n07[];
    static const char HDR_EV_COMP_n10[];
    static const char HDR_EV_COMP_n13[];
    static const char HDR_EV_COMP_n15[];
    static const char HDR_EV_COMP_n17[];
    static const char HDR_EV_COMP_n20[];
    static const char HDR_EV_COMP_n30[];
